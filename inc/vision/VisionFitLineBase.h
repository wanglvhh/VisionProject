...
class CMgrDllVisionFitLineIm : public CMgrDllDelegate
{
public:
#ifdef _DEBUG
	CMgrDllVisionFitLineIm(LPCTSTR lpcszDllPathFullName=_T("VisionFitLineD.dll"))
		: CMgrDllDelegate(lpcszDllPathFullName)
	{
	}
#else
	CMgrDllVisionFitLineIm(LPCTSTR lpcszDllPathFullName=_T("VisionFitLine.dll"))
		: CMgrDllDelegate(lpcszDllPathFullName)
	{
	}
#endif
	virtual ~CMgrDllVisionFitLineIm(){
	}
};

class CVisionFitLineBase
{
public:
