...
void SerialPort::initSerialPort(const char *portName,int nBaudRate,int nByteSize,int nStopBits,int nParity)
{
	...
	else
	{
		...
		else
		{
			...
			dcbSerialParameters.ByteSize = nByteSize;
			dcbSerialParameters.StopBits = nStopBits;
			dcbSerialParameters.Parity = nParity;
