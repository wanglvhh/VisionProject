...
namespace csv
{
    ...
    {
    public:
		Parser(const std::string &data,const std::vector<std::string> &,const DataType &type= eFILE, char sep = ',') ;
    ...
    public:
		...
		//
		void setHeader(std::vector<std::string> Inheader) ;
		void setOriginalFile(std::vector<std::string> Inheader) ;
    //protected:
