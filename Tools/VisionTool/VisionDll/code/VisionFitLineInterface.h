...
#include "VisionFitLineBase.h"
#include "vCriticalSection.h"

class CVisionFitLineInterface :
	public CVisionBase
{
public:
	CVisionFitLineInterface(void);
	~CVisionFitLineInterface(void);
...
private:
	CVisionFitLineBase*         m_pVisionFitLineBase ;
	CMgrDllVisionFitLineIm      m_dllVisionFitLineIm ;
	bool                        m_bInitOk ;
